...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" >
    ...
    <body>
        <div id="app" >
                                ...
                                <ul class="navbar-nav justify-content-center" >
                                    ...
                                    <li class="nav-item dropdown" >
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" >
                                            ...
                                            <a class="dropdown-item bg-km" href="{{ route( "logout" ) }}" onclick="event.preventDefault(); document.getElementById( 'logout-form' ).submit();" >
                                                {{ __( "Logout" ) }}
                                            </a>
            ...
            <footer class="text-center text-secondary pb-2" >
                &copy; {{ date( "Y" ) }} <strong><span>{{ config( "app.name" ) }}</span></strong>.
            </footer>
        </div>
