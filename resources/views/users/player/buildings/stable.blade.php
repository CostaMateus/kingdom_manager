                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "stable" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "stable" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "stable" ][ "name" ] }} (Nível {{ $village->building_stable }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "stable" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
