                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "hide" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "hide" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "hide" ][ "name" ] }} (Nível {{ $village->building_hide }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "hide" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
