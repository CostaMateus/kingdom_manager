                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "clay" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "clay" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "clay" ][ "name" ] }} (Nível {{ $village->building_clay }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "clay" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
