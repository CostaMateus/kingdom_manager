                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "farm" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "farm" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "farm" ][ "name" ] }} (Nível {{ $village->building_farm }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "farm" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
