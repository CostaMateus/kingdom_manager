                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "church" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "church" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "church" ][ "name" ] }} (Nível {{ $village->building_church }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "church" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
