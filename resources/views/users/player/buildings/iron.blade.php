                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "iron" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "iron" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "iron" ][ "name" ] }} (Nível {{ $village->building_iron }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "iron" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
