                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "barracks" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "barracks" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "barracks" ][ "name" ] }} (Nível {{ $village->building_barracks }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "barracks" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
