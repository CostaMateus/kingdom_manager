                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "wall" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "wall" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "wall" ][ "name" ] }} (Nível {{ $village->building_wall }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "wall" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
