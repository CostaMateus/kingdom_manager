                    ...
                    <div class="card-body" >
                        <div class="row" >
                            <div class="col-2 text-center">
                                <img src="{{ asset( "assets/graphic/buildings/{$buildings[ "workshop" ][ "key" ]}1.png" ) }}" alt="{{ $buildings[ "workshop" ][ "name" ] }}" >
                            </div>
                            <div class="col-10" >
                                <p class="h3 mb-2" >
                                    <b>{{ $buildings[ "workshop" ][ "name" ] }} (Nível {{ $village->building_workshop }})</b>
                                </p>
                                <p class="h5 mb-0" >
                                    {{ $buildings[ "workshop" ][ "description" ] }}
                                </p>
                            </div>
                        </div>
